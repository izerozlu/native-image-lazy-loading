...
var mutateImageListItem = function mutateImageListItem(imageListItem, index) {
  var itemImage = imageListItem.querySelector(".image-list__image");
  var itemPlaceholder = imageListItem.querySelector(".image-list__placeholder");
...
var imageListItem = document.querySelector(".image-list__list-item");
mutateImageListItem(imageListItem, 0);
new Array(20).fill(0).forEach(function (item, index) {
  var itemClone = imageListItem.cloneNode(true);
...
},{}]},{},["../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
